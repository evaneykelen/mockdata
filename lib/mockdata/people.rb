module Mockdata
  class People
    ...
    PHYSICISTS_LAST_NAME = ["'t Hooft", "Anderson", "Banks", "Barnard", "Barwich", "Beeckman", "Bennet", "Brüche", "Buchdahl", "Carena", "Carroll", "Chadwick", "Clausius", "Cleaver", "Condon", "Curie", "Cvitanović", "Darwin", "Diebold", "Duarte", "Dunlop", "Durrance", "Dyson", "Einstein", "Englert", "Faraday", "Fermi", "Fischer", "Foucault", "Frank", "Freeman", "Freier", "Getzler", "Gibson", "González", "Green", "Greene", "Grover", "Haag", "Harteck", "Hasenöhrl", "Henry", "Hirschmugl", "Houston", "Houtermans", "Hulse", "Hund", "Isgur", "Ising", "Jucys", "Klein", "LaBelle", "Lee", "Linsley", "Littrow", "Malus", "Marshall", "Maxwell", "Mayer", "Melott", "Michelson", "Monro", "Montgomery", "Mottelson", "Muller", "Newton", "O'Neill", "Oppenheimer", "Pagels", "Panofsky", "Perlmutter", "Perrin", "Planck", "Poisson", "Rabi", "Redner", "Riess", "Rosenbluth", "Rudaz", "Sakata", "Schmidt", "Seiberg", "Silberstein", "Stark", "Sterman", "Strachan", "Sunyaev", "Taylor", "Upatnieks", "Verlinde", "Volmer", "Volta", "Wang", "Wapstra", "Wentzel", "Wirtz", "Wise", "Wolfram", "de Coulomb", "du Châtelet"].freeze
    ...
    def self.physicists_last_name
      PHYSICISTS_LAST_NAME.sample
    end
